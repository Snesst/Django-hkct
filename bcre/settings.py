...
import os # this line is typed in by you
...
SECRET_KEY = 'django-insecure-a-$wytg9z+a-$&%z3)q1us00t5$6(r+&u0#7t84*9m63!2gs2n'
...
INSTALLED_APPS = [
    ...
    'listings.apps.ListingsConfig', #added
    'realtors.apps.RealtorsConfig', #added
